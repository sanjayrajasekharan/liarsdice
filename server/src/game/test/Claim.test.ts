...
import { PlayerId } from 'shared/domain.js';

describe('Claim', () => {
    describe('constructor', () => {
        it('should create a claim with correct properties', () => {
            const claim = new Claim('player1' as PlayerId, 5, 4);
    ...
    describe('validateAgainst', () => {
        it('should accept a claim with higher quantity', () => {
            const oldClaim = new Claim('player1' as PlayerId, 5, 4);
            const newClaim = new Claim('player2' as PlayerId, 6, 3);
        ...
        it('should accept a claim with same quantity but higher face value', () => {
            const oldClaim = new Claim('player1' as PlayerId, 5, 4);
            const newClaim = new Claim('player2' as PlayerId, 5, 5);
        ...
        it('should reject a claim with lower quantity', () => {
            const oldClaim = new Claim('player1' as PlayerId, 5, 4);
            const newClaim = new Claim('player2' as PlayerId, 4, 6);
        ...
        it('should reject a claim with same quantity but lower face value', () => {
            const oldClaim = new Claim('player1' as PlayerId, 5, 4);
            const newClaim = new Claim('player2' as PlayerId, 5, 3);
        ...
        it('should reject a claim with same quantity and same face value', () => {
            const oldClaim = new Claim('player1' as PlayerId, 5, 4);
            const newClaim = new Claim('player2' as PlayerId, 5, 4);
            
            expect(newClaim.validateAgainst(oldClaim)).to.be.false;
        });

        it('should accept progressively higher claims', () => {
            const claim1 = new Claim('player1' as PlayerId, 2, 3);
            const claim2 = new Claim('player2' as PlayerId, 2, 4);
            const claim3 = new Claim('player3' as PlayerId, 3, 1);
