...
export const WithClaims: Story = {
  args: {
    ...
    claims: [
      ...
      { playerId: '1', playerName: 'Alice', quantity: 4, faceValue: 4 },
      { playerId: '1', playerName: 'Alice', quantity: 6, faceValue: 5 },
    ],
    isOpen: true,
    onOpenChange: () => {},
    children: (
...
export const ManyClaims: Story = {
  args: {
    playerName: 'Charlie',
    claims: [
      { playerId: '3', playerName: 'Charlie', quantity: 1, faceValue: 1 },
      { playerId: '3', playerName: 'Charlie', quantity: 2, faceValue: 2 },
      { playerId: '3', playerName: 'Charlie', quantity: 3, faceValue: 3 },
      { playerId: '3', playerName: 'Charlie', quantity: 4, faceValue: 4 },
      { playerId: '3', playerName: 'Charlie', quantity: 5, faceValue: 5 },
      { playerId: '3', playerName: 'Charlie', quantity: 6, faceValue: 6 },
    ],
    isOpen: true,
    onOpenChange: () => {},
    children: (
