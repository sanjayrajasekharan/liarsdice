...
import PlayersDisplay from '@components/game/players/PlayersDisplay/PlayersDisplay';
import ClaimInput from '@components/game/claims/ClaimInput/ClaimInput';
import ClaimTimeline from '@components/game/claims/ClaimTimeline/ClaimTimeline';
...
const Round: React.FC = () => {
  ...
  const currentClaim = useGameState(selectCurrentClaim);
  ...
  return (
    <AnimatePresence mode="wait">
      {!showRound ? (
        ...
        >
          <Dice dice={myDice} isRolling={true} />
        </motion.div>
      ) : (
        <motion.div
